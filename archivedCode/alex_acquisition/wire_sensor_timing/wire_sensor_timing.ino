...
void loop() {
  ...
  xydat[0] = xydat[0] + 2048;
  xydat[1] = xydat[1] + 2048;
  if (xydat[0] > 4095)
    {
      xydat[0] = 4095; 
    }
  ...
  Wire.write(2048 >> 4);        // the 8 most significant bits...
  Wire.write((2048 & 15) << 4); // the 4 least significant bits...
  ...
  //Wire.write(64);                     // cmd to update the DAC
  //Wire.write(xydat[1] >> 4);        // the 8 most significant bits...
  //Wire.write((xydat[1] & 15) << 4); // the 4 least significant bits...
